...
- Added `text` field to every entry in `enemies.json` - flavour descriptions for examine mode

**Spellcasting Balance**
- Rebalanced spell failure formula: `BASE_FAILURE 30→25`, `INT_WEIGHT 3.0→3.5`
- Reduced mana costs for levels 2-5 spells by ~15%
